...
function Hero() {
  ...
  return (
    <section id="top" className="relative min-h-screen flex items-end pt-16">
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-8 pb-10 md:pt-16 md:pb-24 text-white w-full">
        <div className="flex items-center gap-2 text-sm mt-6 md:mt-10 mb-4 text-white/80 animate-fade-in">
